...
namespace GLT::logger_default {
    ...
    void log_msg_internal(const GLT::logger::severity msg_sev, const GLT::logger::owned_source_location location, 
        const std::string module_name, std::thread::id thread_id, std::string message);
