...
namespace GLT::editor {
    ...
    private:
        ...
        void draw_file_item(const GLT::vfs::directory_entry& entry);

        void draw_background_context_menu();

        void draw_item_context_menu(const GLT::vfs::directory_entry& entry);
        ...
        std::vector<GLT::vfs::directory_entry>      m_entries{};              // Cached children of m_current_dir.
