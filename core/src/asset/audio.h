...
namespace GLT::asset::audio {
    ...
    public:
        ...
        [[nodiscard]] GLT::asset::type type() const noexcept override { return asset_type; }


        [[nodiscard]] u64 memory_usage() const noexcept override { return sizeof(*this) + samples.capacity() * sizeof(f32); }
